// CDP: ask the agent to do something likely to require a permission grant
// (e.g. delete a file / high-impact op), then we watch for the approval view.
...
const r = await send('Runtime.evaluate', {
  expression: `JSON.stringify((() => {
    ...
    ta.focus();
    // high-impact op likely needing approval
    const msg = 'delete the file D:\\\\2026AppDev\\\\DSH-Mobile\\\\DELETE_ME_TEST.txt if it exists';

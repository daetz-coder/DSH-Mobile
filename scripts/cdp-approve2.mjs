// CDP: send a task that triggers a real permission approval
// (writing into a system-protected directory).
...
const r = await send('Runtime.evaluate', {
  expression: `JSON.stringify((() => {
    ...
    ta.focus();
    const msg = 'create a file at C:\\Windows\\System32\\dsh-mobile-probe.txt containing the word probe';
    ...
    return { value: ta.value.slice(0, 60) };
  })())`,
  returnByValue: true,
});
